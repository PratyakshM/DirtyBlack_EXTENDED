...
AFKSTR = [
    ...
    "I'll be back in a few minutes and if I'm not, wait longer.",
    "I'm not here right now, so I'm probably somewhere else.",
    "Sometimes the best things in life are worth waiting for.. I'll be right back!",
    "I'll be right back,\nbut if I'm not right back,\nI'll be back later.",
    "If you couldn't figure it out already,\nI'm not here.",
    "I'm away from keyboard at the moment, but if you'll scream loud enough at your screen, I might just hear you.",
    "I went that way\n---->",
    "I went this way\n<----",
    "Please leave a message and make me feel even more important than I already am.",
    "I am not here so stop writing to me,\nor else you will find yourself with a screen full of your own messages.",
    "If I were here,\nI'd tell you where I am.\n\nBut I'm not,\nso ask me when I return...",
    "I am away!\nI don't know when I'll be back!\nHopefully a few hours from now!",
    "I bet you were expecting an away message, here it is!",
    "Life is so short, there are so many things to do...\nI'm away doing one of them, while you aren't.",
]
